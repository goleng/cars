...
Welcome to `cars` contributor's guide.
...
If you experience bugs or general issues with `cars`, please have a look
...
You can help improve `cars` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cars` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cars`'s files. While this mechanism can
...
```
conda create -n cars python=3 six virtualenv pytest pytest-cov
conda activate cars
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cars.git
   cd cars
   ```
...
5. Install [pre-commit]:
   ...
   `cars` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cars
[issue tracker]: https://github.com/<USERNAME>/cars/issues
